...
対象バージョン: **v3.2（Full版）**。
Lite版・Trial版との違いは [17. 版（エディション）の違い](docs/17-editions.md) にまとめています。
...
v3.1.2 Lite から乗り換える方は、まずここを確認してください。

| 変更 | 説明している章 |
|---|---|
| **narou.rs 連携と登録作品の管理**（Full版）。連載中のWeb小説を登録し、新着話を取り込んで更新できる | [11章](docs/11-narou.md) |
...
| [11. Web小説をEPUB化する（小説URL）](docs/11-narou.md) | narou.rs 連携、登録作品の管理と更新（Full版） |
