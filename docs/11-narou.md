...
| narou.rs | narou.rs方式を使うとき（Full版） | https://github.com/Rumia-Channel/narou.rs |

![EPUB作成ヘルパー](../images/narou-epub-fetcher.png)

> 📸 写真は v3.2 Full版です。取得方式に narou.rs を選んでおり、「登録作品」タブも使えます。
> Lite版ではこの欄がグレー表示になります。
...
| 取得方式 | しくみ | 向いている使い方 |
|---|---|---|
| **narou.rs**（Full版の既定） | narou.rs が作品を取得・管理し、AozoraEpub3 でEPUBにします。同じ作品をもう一度実行すると、新しく公開された話だけを取りにいきます | **連載中の作品を追いかける**。作品は「登録作品」一覧に入り、まとめて更新できます |
...
- **登録作品** … narou.rsで管理している作品の一覧（[後述](#登録作品full版)）
...
Lite版では取得方式が **AozoraEpub3直接のみ** で、narou.rs方式と登録作品の一覧は使えません
（画面上はグレー表示になります）。URLを入力して1作品ずつEPUBにする使い方になります
（→ [17章](17-editions.md)）。
